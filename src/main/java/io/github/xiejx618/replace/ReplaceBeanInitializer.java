...
public class ReplaceBeanInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext context) {
        ...
        List<String> packages = optimizeConfig(environment.getPropertySources());
        ReplaceBeanPostProcessor.registerFromScan(context, packages);
     ...
     * @return 获取优化后的配置
     */
    private static List<String> optimizeConfig(MutablePropertySources propertySources) {
